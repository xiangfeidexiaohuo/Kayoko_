...
- (UISwipeActionsConfiguration *)tableView:(UITableView *)tableView leadingSwipeActionsConfigurationForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if ([item hasMusicLink]) {
        UIContextualAction* odesliAction = [UIContextualAction contextualActionWithStyle:UIContextualActionStyleNormal title:@"" handler:^(UIContextualAction* _Nonnull action, __kindof UIView* _Nonnull sourceView, void (^ _Nonnull completionHandler)(BOOL)) {
            [[PasteboardManager sharedInstance] addOdesliItemFromItem:item];
            completionHandler(YES);
        }];
        [odesliAction setImage:[UIImage systemImageNamed:@"music.note"]];
        [odesliAction setBackgroundColor:[UIColor systemPurpleColor]];
